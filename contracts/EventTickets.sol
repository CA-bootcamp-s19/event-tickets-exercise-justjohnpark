...
contract EventTickets {
    ...
    */
    event LogBuyTickets(address buyer, uint ticketNum);
    event LogGetRefund(address refundRequester, uint ticketNum);
    event LogEndSale(address owner, uint transferBalance);
    ...
    */
        ...
        payable
    {
        ...
        require (myEvent.totalTickets - myEvent.sales >= numTickets);
    ...
    */
        ...
        verifyOwner
    {
        ...
        emit LogEndSale(msg.sender, accountBalance);
    }
}